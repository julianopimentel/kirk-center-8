...
Route::group(['middleware' => ['auth:sanctum']], function() {
    ...
    //account
    Route::get('/account', [AccountController::class, 'index']); // all posts
    Route::post('/account/{id}', [AccountController::class, 'tenant']); // get single post

    //people
    Route::get('/people/{id}', [PeopleController::class, 'index']); // all posts
    Route::get('/people/{tenant}/{id}', [PeopleController::class, 'show']); // all posts
