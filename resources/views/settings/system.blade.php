                            ...
                            <div class="card-body">
                                <form action="{{ route('settings.updateSystem') }}" method="POST">
                                    ...
                                    <!--
                                                        ...
                                                        -->
                                                        <label class="control-label"><strong>Configurações do Sistema
                                                        </strong></label>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="currency"
                                                    placeholder="currency" value="{{ $settings->currency }}" maxlength="5"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="inner">
                                            <div class="form-check form-check-inline mr-1">
                                                ...
                                                <label
                                                    ...
                                                    geolocalização <span class="badge badge-info">Beta</span></label>
                                            </div>
                                        </div><small>Usado para implantação de igrejas, mas é necessário
                                            informar a latitude
