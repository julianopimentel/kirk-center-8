...
!(function (t, e) {
        ...
        Z = (function () {
            ...
            return (
                ...
                (n._setUpUrl = function (t) {
                    (t = t.replace(/^\//, "").split("?")[0]),
                        ...
                        Array.from(document.querySelectorAll($)).forEach(
                            function (e) {
                                Array.from(
                                    e.querySelectorAll('a[href*="' + t + '"]')
                                ).length > 0 && e.classList.add(K);
                            }
                        ),
                        Array.from(
                            document.querySelectorAll(
                                '.c-sidebar-nav-item a[href*="' + t + '"]'
                            )
                        ).forEach(function (t) {
                            t.classList.add(z);
                        }),
                ...
                (n._update = function (t) {
                    "#" !== t.href &&
                        (("undefined" != typeof t.dataset.toggle &&
                            "null" !== t.dataset.toggle) ||
                            ("_top" === t.target
                                ? this._loadTop(t.href)
                                : "_blank" === t.target
                                ? this._loadBlank(t.href)
                                : this._setUpUrl(t.getAttribute("href"))));
                }),
                (n._addEventListeners = function () {
                    ...
                    Q.on(
                        ...
                        function (e) {
                            e.preventDefault();
                            var n = e.target;
                            n.classList.contains("c-sidebar-nav-link") ||
                                (n = n.closest(G)),
    ...
    if (tt) {
        var et = tt.fn[F];
        (tt.fn[F] = Z.jQueryInterface),
            (tt.fn[F].Constructor = Z),
            (tt.fn[F].noConflict = function () {
            ...
            return (
                ...
                (n._destroyElement = function (t) {
                    t.parentNode && t.parentNode.removeChild(t),
                        Q.trigger(t, "closed.coreui.alert");
                }),
                (t.jQueryInterface = function (e) {
                    return this.each(function () {
                        var n = k(this, nt);
    ...
    Q.on(
        ...
        '[data-dismiss="alert"]',
        it.handleDismiss(new it())
    );
    var ot = E();
    if (ot) {
        var rt = ot.fn.alert;
        (ot.fn.alert = it.jQueryInterface),
            (ot.fn.alert.Constructor = it),
            (ot.fn.alert.noConflict = function () {
            ...
            return (
                (n.toggle = function () {
                        ...
                        if (i && "radio" === i.type) {
                            ...
                            if (t) {
                                if (
                                    ...
                                    i.classList.contains(ct) ||
                                    n.classList.contains(ct)
                                )
                                    return;
                                (i.checked =
                                    !this._element.classList.contains(lt)),
                    ...
                    e &&
                        ...
                        t && this._element.classList.toggle(lt);
                }),
                (n.dispose = function () {
    ...
    if (pt) {
        var gt = pt.fn.button;
        (pt.fn.button = dt.jQueryInterface),
            (pt.fn.button.Constructor = dt),
            (pt.fn.button.noConflict = function () {
        ...
        xt = (function () {
            function t(t, e) {
                (this._items = null),
                    ...
                    (this._element = t),
                    (this._indicatorsElement = st.findOne(
                        ".carousel-indicators",
                        this._element
                    )),
            ...
            return (
                ...
                (n.to = function (t) {
                    ...
                    if (!(t > this._items.length - 1 || t < 0))
                        if (this._isSliding)
                            Q.one(this._element, Ot, function () {
                                return e.to(t);
                            });
                        else {
                ...
                (n._getItemIndex = function (t) {
                    return (
                        (this._items =
                            t && t.parentNode
                                ? st.find(".carousel-item", t.parentNode)
                                : []),
                ...
                (n._setActiveIndicatorElement = function (t) {
                    if (this._indicatorsElement) {
                        for (
                            var e = st.find(".active", this._indicatorsElement),
                                n = 0;
                            n < e.length;
                            n++
                        )
                ...
                (n._slide = function (t, e) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            s.classList.remove(Ct),
                                l.classList.add(Ct),
                                (this._isSliding = !1),
                                Q.trigger(this._element, Ot, {
                                    relatedTarget: l,
                                    direction: o,
                                    from: a,
                                    to: u,
    ...
    Q.on(
        ...
        Q.on(window, "load.coreui.carousel.data-api", function () {
            for (
                var t = st.find('[data-ride="carousel"]'), e = 0, n = t.length;
                e < n;
                e++
            )
    ...
    if (Dt) {
        var jt = Dt.fn[bt];
        (Dt.fn[bt] = xt.jQueryInterface),
            (Dt.fn[bt].Constructor = xt),
            (Dt.fn[bt].noConflict = function () {
        ...
        Yt = (function () {
            ...
            return (
                                  ...
                                  ? t
                                        ...
                                        .forEach(function (n) {
                                            (t._config.removeClass = n),
                                                t.remove(),
                                                t._customEvent(Ht, e, !1, n);
                                        })
                                  : ((t._config.addClass = n),
                                    t.add(),
                                    t._customEvent(Ht, e, !0, n));
                          })
                        : n.forEach(function (n) {
                ...
                (n._includesResponsiveClass = function (t) {
                    var e = this;
                    return this._updateResponsiveClassNames(t).filter(function (
                        t
                    ) {
                ...
                (n._getConfig = function (t) {
                    return (
                        ...
                        _(Nt, t, this.constructor.DefaultType),
                        t
                    );
                }),
    ...
    Q.on(document, "click.coreui.class-toggler.data-api", Wt, function (t) {
        ...
        var e = t.target;
        e.classList.contains("c-class-toggler") || (e = e.closest(Wt)),
            "undefined" != typeof e.dataset.addClass &&
                Yt.classTogglerInterface(e, "add"),
            "undefined" != typeof e.dataset.removeClass &&
                Yt.classTogglerInterface(e, "remove"),
            "undefined" != typeof e.dataset.toggleClass &&
                Yt.classTogglerInterface(e, "toggle"),
            "undefined" != typeof e.dataset.class &&
                Yt.classTogglerInterface(e, "class");
    });
    var Xt = E();
    if (Xt) {
        var Bt = Xt.fn[Nt];
        (Xt.fn[Nt] = Yt.jQueryInterface),
            (Xt.fn[Nt].Constructor = Yt),
            (Xt.fn[Nt].noConflict = function () {
            ...
            return (
                ...
                (n.show = function () {
                    ...
                    if (
                        ...
                        if (
                            !Q.trigger(this._element, "show.coreui.collapse")
                                .defaultPrevented
                        ) {
                            n &&
                            ...
                            Q.one(this._element, c, function () {
                                e._element.classList.remove(Kt),
                                    e._element.classList.add(zt, Vt),
                                    (e._element.style[s] = ""),
                ...
                (n.hide = function () {
                    ...
                    if (
                        !this._isTransitioning &&
                        this._element.classList.contains(Vt) &&
                        !Q.trigger(this._element, "hide.coreui.collapse")
                            .defaultPrevented
                    ) {
                        ...
                        (this._element.style[e] =
                            ...
                            w(this._element),
                            this._element.classList.add(Kt),
                            this._element.classList.remove(zt, Vt);
                        ...
                        Q.one(this._element, c, function () {
                            t.setTransitioning(!1),
                                t._element.classList.remove(Kt),
                                t._element.classList.add(zt),
                                Q.trigger(t._element, "hidden.coreui.collapse");
                        }),
                            v(this._element, s);
                    }
                }),
                ...
                (n._getConfig = function (t) {
                    return (
                        ((t = o(o({}, Qt), t)).toggle = Boolean(t.toggle)),
                        _(Ut, t, Ft),
                        t
                    );
                }),
                ...
                (n._getParent = function () {
                    ...
                    m(e)
                        ? ("undefined" == typeof e.jquery &&
                              "undefined" == typeof e[0]) ||
                          (e = e[0])
                        : (e = st.findOne(e));
                    var n = Jt + '[data-parent="' + e + '"]';
                    return (
                        st.find(n, e).forEach(function (e) {
                            var n = d(e);
                ...
                (n._addAriaAndCollapsedClass = function (t, e) {
                    if (t && e.length) {
                        ...
                        e.forEach(function (t) {
                            n ? t.classList.remove($t) : t.classList.add($t),
        ...
        st.find(n).forEach(function (t) {
            ...
            i
                ? (null === i._parent &&
                  ...
                  (n = "toggle"))
                : (n = e),
                Zt.collapseInterface(t, n);
        });
    });
    var te = E();
    if (te) {
        var ee = te.fn[Ut];
        (te.fn[Ut] = Zt.jQueryInterface),
            (te.fn[Ut].Constructor = Zt),
            (te.fn[Ut].noConflict = function () {
                ...
                (("body" !== ae(e) || fe(o)) &&
                    (a =
                        (i = e) !== ie(i) && se(i)
                            ...
                            : oe(i)),
                se(e)
                    ? (((l = ne(e)).x += e.clientLeft), (l.y += e.clientTop))
                    : o && (l.x = ce(o))),
            {
    ...
    function pe(t) {
        return "html" === ae(t)
            ? t
            : t.assignedSlot || t.parentNode || t.host || le(t);
    }
    function ge(t, e) {
        void 0 === e && (e = []);
        var n = (function t(e) {
    ...
    function ve(t) {
        ...
        if (e) {
            ...
            if (
                "body" === ae(e) &&
                "static" === ue(e).position &&
                "static" !== ue(n).position
            )
                return n;
        }
        return e;
    ...
    function _e(t) {
        for (
            var e = ie(t), n = ve(t);
            n && me(n) && "static" === ue(n).position;

        )
            n = ve(n);
        return n && "body" === ae(n) && "static" === ue(n).position
            ? e
            : n ||
                  (function (t) {
                      for (
                          var e = pe(t);
                          se(e) && ["html", "body"].indexOf(ae(e)) < 0;
    ...
    function Ke(t) {
        ...
        var _,
            b = Object.assign({ position: s }, l && ze);
        return a
            ? Object.assign(
                  Object.assign({}, b),
                  {},
            ...
            defaultModifiers: [
                {
                    ...
                    effect: function (t) {
                        ...
                        return (
                            ...
                            a && l.addEventListener("resize", n.update, Ve),
                            function () {
                                r &&
                                    c.forEach(function (t) {
                ...
                },
                {
                    ...
                    effect: function (t) {
                        ...
                        null != r &&
                            ...
                            Ie(e.elements.popper, r) &&
                            ((e.elements.arrow = r),
                            (e.modifiersData[i + "#persistent"] = {
                                padding: Xe(
                                    "number" != typeof a ? a : Be(a, Te)
                                ),
                            }));
                    },
                    requires: ["popperOffsets"],
                ...
                },
                {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            ...
                            s = Ue(e, { elementContext: "reference" }),
                            a = Ue(e, { altBoundary: !0 }),
                            l = nn(s, i),
                            c = nn(a, o, r),
                            u = on(l),
                            f = on(c);
            ...
            return (
                    ...
                    if (
                        ...
                        if (
                            ...
                            this._element.focus(),
                                ...
                                _t.toggleClass(this._menu, bn),
                                _t.toggleClass(e, bn),
                                Q.trigger(e, "shown.coreui.dropdown", n);
                        }
                    }
                }),
                (n.hide = function () {
                    if (
                        ...
                        var e = t.getParentFromElement(this._element),
                            n = { relatedTarget: this._element };
                        Q.trigger(e, pn, n).defaultPrevented ||
                ...
                (n._getConfig = function (t) {
                    return (
                        ...
                        _(sn, t, this.constructor.DefaultType),
                        t
                    );
                }),
                ...
                (n._getPlacement = function () {
                    ...
                    return (
                        t.classList.contains("dropup")
                            ? ((e = "top-start"),
                              this._menu.classList.contains(yn) &&
                                  (e = "top-end"))
                ...
                (n._getPopperConfig = function () {
                    var t = {
                        ...
                        modifiers: [
                            ...
                            { name: "flip", enabled: this._config.flip },
                            {
                                name: "preventOverflow",
                ...
                (t.clearMenus = function (e) {
                    if (
                        ...
                        for (
                            var n = st.find(wn), i = 0, o = n.length;
                            i < o;
                            i++
                        ) {
                ...
                (t.dataApiKeydownHandler = function (e) {
                    if (
                        ...
                        (e.preventDefault(),
                        e.stopPropagation(),
                        !this.disabled && !this.classList.contains(_n))
                    ) {
    ...
    Q.on(document, vn, wn, kn.dataApiKeydownHandler),
        Q.on(document, vn, En, kn.dataApiKeydownHandler),
        Q.on(document, mn, kn.clearMenus),
        Q.on(document, "keyup.coreui.dropdown.data-api", kn.clearMenus),
        Q.on(document, mn, wn, function (t) {
            t.preventDefault(),
                t.stopPropagation(),
                kn.dropdownInterface(this, "toggle");
        }),
    ...
    if (On) {
        var Cn = On.fn[sn];
        (On.fn[sn] = kn.jQueryInterface),
            (On.fn[sn].Constructor = kn),
            (On.fn[sn].noConflict = function () {
    ...
    var Sn = "modal",
        ...
        xn = "." + An,
        Dn = "Escape",
        jn = { backdrop: !0, keyboard: !0, focus: !0, show: !0 },
        Nn = {
        ...
        Vn = (function () {
            function t(t, e) {
                (this._config = this._getConfig(e)),
                    (this._element = t),
                    (this._dialog = st.findOne(".modal-dialog", t)),
                    (this._backdrop = null),
                    (this._isShown = !1),
            ...
            return (
                ...
                (n.hide = function (t) {
                    ...
                    if (
                        ...
                        !Q.trigger(this._element, "hide.coreui.modal")
                            .defaultPrevented
                    ) {
                        this._isShown = !1;
                        ...
                        if (
                            ...
                            Q.off(this._element, Hn),
                            Q.off(this._dialog, Yn),
                            n)
                        ) {
                ...
                (n._showElement = function (t) {
                    ...
                    var o = function () {
                        e._config.focus && e._element.focus(),
                            ...
                            Q.trigger(e._element, "shown.coreui.modal", {
                                relatedTarget: t,
                            });
                    };
                    if (n) {
                ...
                (n._setEscapeEvent = function () {
                    var t = this;
                    this._isShown
                        ? Q.on(this._element, Wn, function (e) {
                              t._config.keyboard && e.key === Dn
                ...
                (n._showBackdrop = function (t) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ...
                            Q.on(this._element, Hn, function (t) {
                            ...
                            n && w(this._backdrop),
                            this._backdrop.classList.add(Un),
                            !n)
                        )
                            return void t();
                ...
                (n._triggerBackdropTransition = function () {
                    ...
                    if ("static" === this._config.backdrop) {
                        ...
                        Q.off(this._element, c),
                            Q.one(this._element, c, function () {
                                t._element.classList.remove(qn),
                                    e ||
                                        (Q.one(t._element, c, function () {
                ...
                (n._setScrollbar = function () {
                    ...
                    if (this._isBodyOverflowing) {
                        st.find(Qn).forEach(function (e) {
                            ...
                            _t.setDataAttribute(e, "padding-right", n),
                            ...
                            st.find(Fn).forEach(function (e) {
                                ...
                                _t.setDataAttribute(e, "margin-right", n),
                                    (e.style.marginRight =
                                        parseFloat(i) -
                                        t._scrollbarWidth +
                                        "px");
                        ...
                        _t.setDataAttribute(document.body, "padding-right", e),
                ...
                (t.jQueryInterface = function (e, n) {
                    return this.each(function () {
                        var i = k(this, An),
                            r = o(
                                o(o({}, jn), _t.getDataAttributes(this)),
                                "object" == typeof e && e ? e : {}
                            );
    ...
    if (zn) {
        var Kn = zn.fn.modal;
        (zn.fn.modal = Vn.jQueryInterface),
            (zn.fn.modal.Constructor = Vn),
            (zn.fn.modal.noConflict = function () {
                        ...
                        (function (t, e) {
                            ...
                            if (-1 !== e.indexOf(n))
                                return (
                                    -1 === $n.indexOf(n) ||
                                    Boolean(
                                        t.nodeValue.match(Gn) ||
                                            t.nodeValue.match(Jn)
                                    )
                                );
                            for (
            ...
            return (
                ...
                (n.dispose = function () {
                    clearTimeout(this._timeout),
                        O(this.element, this.constructor.DATA_KEY),
                ...
                (n.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        o.setAttribute("id", r),
                            ...
                            this.setContent(),
                            this.config.animation && o.classList.add(ui);
                        var s,
                            a =
                        ...
                        var h = function () {
                            ...
                            var e = t._hoverState;
                            (t._hoverState = null),
                                Q.trigger(t.element, t.constructor.Event.SHOWN),
                                e === di && t._leave(null, t);
                        };
                ...
                (n.hide = function () {
                    ...
                    if (
                        ...
                        if (
                            ...
                            this.tip.classList.contains(ui))
                        ) {
                            var o = p(e);
                            Q.one(e, c, n), v(e, o);
                        } else n();
                ...
                (n._getContainer = function () {
                    return !1 === this.config.container
                        ...
                        : st.findOne(this.config.container);
                }),
                ...
                (n._enter = function (t, e) {
                    ...
                    (e = e || k(t.delegateTarget, n)) ||
                        ((e = new this.constructor(
                            t.delegateTarget,
                            this._getDelegateConfig()
                        )),
                        T(t.delegateTarget, n, e)),
                        t &&
                            (e._activeTrigger["focusin" === t.type ? gi : pi] =
                                !0),
                ...
                (n._leave = function (t, e) {
                    ...
                    (e = e || k(t.delegateTarget, n)) ||
                        ...
                        T(t.delegateTarget, n, e)),
                        t &&
                            (e._activeTrigger["focusout" === t.type ? gi : pi] =
                                !1),
                ...
                (n._getConfig = function (t) {
                    ...
                    return (
                        ...
                        _(ei, t, this.constructor.DefaultType),
                        t.sanitize &&
                            (t.template = ti(
                                t.template,
                                t.whiteList,
    ...
    if (vi) {
        ...
        (vi.fn.tooltip = mi.jQueryInterface),
            (vi.fn.tooltip.Constructor = mi),
            (vi.fn.tooltip.noConflict = function () {
        ...
        Oi = (function (t) {
            ...
            return (
                ...
                (r.setContent = function () {
                    var t = this.getTipElement();
                    this.setElementContent(
                        st.findOne(".popover-header", t),
                        this.getTitle()
                    );
                    var e = this._getContent();
                    "function" == typeof e && (e = e.call(this.element)),
                        this.setElementContent(
                            st.findOne(".popover-body", t),
                            e
                        ),
    ...
    if (Ci) {
        ...
        (Ci.fn.popover = Oi.jQueryInterface),
            (Ci.fn.popover.Constructor = Oi),
            (Ci.fn.popover.noConflict = function () {
    ...
    if (Wi) {
        var Yi = Wi.fn[Ai];
        (Wi.fn[Ai] = Hi.jQueryInterface),
            (Wi.fn[Ai].Constructor = Hi),
            (Wi.fn[Ai].noConflict = function () {
    ...
    function ro(t, e, n, i, o) {
        ...
        !(function (t, e, n, i, o) {
            ...
            e &&
                (f.dispatchEvent(oo("ps-scroll-" + l)),
                e < 0
                    ? f.dispatchEvent(oo("ps-scroll-" + c))
                    : e > 0 && f.dispatchEvent(oo("ps-scroll-" + u)),
                i &&
                    (function (t, e) {
                        Zi(t, e), to(t, e);
                    })(t, l));
            t.reach[l] &&
                (e || o) &&
                f.dispatchEvent(oo("ps-" + l + "-reach-" + t.reach[l]));
        })(t, n, r, i, o);
    }
    function so(t) {
    ...
    function lo(t) {
        ...
        (t.containerWidth = Math.ceil(i.width)),
            ...
            e.contains(t.scrollbarXRail) ||
                (Vi(e, $i.rail("x")).forEach(function (t) {
                    return Fi(t);
                }),
                e.appendChild(t.scrollbarXRail)),
            e.contains(t.scrollbarYRail) ||
                (Vi(e, $i.rail("y")).forEach(function (t) {
                    return Fi(t);
                }),
            ...
            t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
                ? ((t.scrollbarXActive = !0),
                  ...
                  (t.scrollbarXWidth = co(
                      t,
                      so((t.railXWidth * t.containerWidth) / t.contentWidth)
                  )),
                  (t.scrollbarXLeft = so(
            ...
            t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
                ? ((t.scrollbarYActive = !0),
                  ...
                  (t.scrollbarYHeight = co(
                      t,
                      so((t.railYHeight * t.containerHeight) / t.contentHeight)
                  )),
                  (t.scrollbarYTop = so(
            ...
            t.scrollbarXActive
                ? e.classList.add(Gi.active("x"))
                : (e.classList.remove(Gi.active("x")),
                  (t.scrollbarXWidth = 0),
                  (t.scrollbarXLeft = 0),
                  (e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
            t.scrollbarYActive
                ? e.classList.add(Gi.active("y"))
                : (e.classList.remove(Gi.active("y")),
    ...
    function uo(t, e) {
        ...
        function m() {
            to(t, c),
                t[u].classList.remove(Gi.clicking),
    ...
    var fo = {
            ...
            keyboard: function (t) {
                ...
                t.event.bind(t.ownerDocument, "keydown", function (n) {
                    if (
                        ...
                        (Qi(e, ":hover") ||
                            Qi(t.scrollbarX, ":focus") ||
                            Qi(t.scrollbarY, ":focus"))
                    ) {
                        var i,
                        ...
                        if (o) {
                            ...
                            if (
                                Qi((i = o), "input,[contenteditable]") ||
                                Qi(i, "select,[contenteditable]") ||
                                Qi(i, "textarea,[contenteditable]") ||
                                Qi(i, "button,[contenteditable]")
                            )
                                return;
                        }
                        var r = 0,
            ...
            wheel: function (t) {
                ...
                function n(n) {
                    ...
                    if (
                        !(function (t, n, i) {
                            if (!ao.isWebKit && e.querySelector("select:focus"))
                                return !0;
                            if (!e.contains(t)) return !1;
                            for (var o = t; o && o !== e; ) {
                                if (o.classList.contains($i.consuming))
                                    return !0;
                                var r = Xi(o);
        ...
        ho = function (t, e) {
            ...
            (this.isRtl = "rtl" === Xi(t).direction),
                !0 === this.isRtl && t.classList.add(Ki),
                ...
                (this.scrollbarXRail = Ui($i.rail("x"))),
                t.appendChild(this.scrollbarXRail),
                (this.scrollbarX = Ui($i.thumb("x"))),
            ...
            (this.scrollbarXBottom = parseInt(l.bottom, 10)),
                isNaN(this.scrollbarXBottom)
                    ? ((this.isScrollbarXUsingBottom = !1),
                      (this.scrollbarXTop = so(l.top)))
                    : (this.isScrollbarXUsingBottom = !0),
                (this.railBorderXWidth =
                    so(l.borderLeftWidth) + so(l.borderRightWidth)),
                Bi(this.scrollbarXRail, { display: "block" }),
                (this.railXMarginWidth = so(l.marginLeft) + so(l.marginRight)),
                Bi(this.scrollbarXRail, { display: "" }),
                (this.railXWidth = null),
                (this.railXRatio = null),
                (this.scrollbarYRail = Ui($i.rail("y"))),
                t.appendChild(this.scrollbarYRail),
                (this.scrollbarY = Ui($i.thumb("y"))),
                ...
                (this.scrollbarYOuterWidth = this.isRtl
                    ? (function (t) {
                          ...
                          return (
                              ...
                              so(e.paddingLeft) +
                              so(e.paddingRight) +
                              so(e.borderLeftWidth) +
                              so(e.borderRightWidth)
                          );
                      })(this.scrollbarY)
                    : null),
                (this.railBorderYWidth =
                    so(c.borderTopWidth) + so(c.borderBottomWidth)),
                Bi(this.scrollbarYRail, { display: "block" }),
                (this.railYMarginHeight = so(c.marginTop) + so(c.marginBottom)),
                Bi(this.scrollbarYRail, { display: "" }),
    ...
    (ho.prototype.update = function () {
        this.isAlive &&
            ...
            (this.railXMarginWidth =
                so(Xi(this.scrollbarXRail).marginLeft) +
                so(Xi(this.scrollbarXRail).marginRight)),
            (this.railYMarginHeight =
                so(Xi(this.scrollbarYRail).marginTop) +
                so(Xi(this.scrollbarYRail).marginBottom)),
            Bi(this.scrollbarXRail, { display: "none" }),
            Bi(this.scrollbarYRail, { display: "none" }),
            lo(this),
            ro(this, "top", 0, !1, !0),
            ro(this, "left", 0, !1, !0),
            Bi(this.scrollbarXRail, { display: "" }),
        ...
        (ho.prototype.onScroll = function (t) {
            this.isAlive &&
                (lo(this),
                ro(this, "top", this.element.scrollTop - this.lastScrollTop),
                ro(this, "left", this.element.scrollLeft - this.lastScrollLeft),
        ...
        (ho.prototype.destroy = function () {
            this.isAlive &&
                ...
                Fi(this.scrollbarX),
                Fi(this.scrollbarY),
                Fi(this.scrollbarXRail),
                Fi(this.scrollbarYRail),
    ...
    var po = "sidebar",
        ...
        Ao = (function () {
            ...
            return (
                (n.open = function (t) {
                    var e = this;
                    Q.trigger(this._element, "open.coreui.sidebar"),
                        this._isMobile()
                            ? (this._addClassName(
                    ...
                    Q.one(this._element, c, function () {
                        !0 === e._isVisible() &&
                            ((e._open = !0),
                            Q.trigger(e._element, "opened.coreui.sidebar"));
                    }),
                        v(this._element, n);
                }),
                (n.close = function (t) {
                    var e = this;
                    Q.trigger(this._element, "close.coreui.sidebar"),
                        this._isMobile()
                    ...
                    Q.one(this._element, c, function () {
                        !1 === e._isVisible() &&
                            ((e._open = !1),
                            Q.trigger(e._element, "closed.coreui.sidebar"));
                    }),
                        v(this._element, n);
                }),
                (n.toggle = function (t) {
                ...
                (n.minimize = function () {
                    this._isMobile() ||
                        (this._addClassName(wo),
                        (this._minimize = !0),
                        this._psDestroy());
                }),
                (n.unfoldable = function () {
                    this._isMobile() ||
                        (this._addClassName(Eo), (this._unfoldable = !0));
                }),
                (n.reset = function () {
                    this._element.classList.contains(wo) &&
                        (this._element.classList.remove(wo),
                        (this._minimize = !1),
                        Q.one(this._element, c, this._psInit())),
                ...
                (n._getConfig = function (t) {
                    return (
                        ...
                        _(po, t, this.constructor.DefaultType),
                        t
                    );
                }),
                ...
                (n._showBackdrop = function () {
                    this._backdrop ||
                        ...
                        document.body.appendChild(this._backdrop),
                        w(this._backdrop),
                        this._backdrop.classList.add(yo));
                }),
                (n._clickOutListener = function (t, e) {
                    null === t.target.closest(So) &&
                ...
                (n._toggleDropdown = function (t, e) {
                    var n = t.target;
                    n.classList.contains("c-sidebar-nav-dropdown-toggle") ||
                        (n = n.closest(To));
                    var i = n.closest(Co).dataset;
                    "undefined" != typeof i.dropdownAccordion &&
                        (mo.dropdownAccordion = JSON.parse(
                            i.dropdownAccordion
                        )),
                        !0 === mo.dropdownAccordion &&
                            this._getAllSiblings(n.parentElement, function (t) {
                        ...
                        n.parentNode.classList.toggle(yo),
                        e._psUpdate();
                }),
                (n._psInit = function () {
                    this._element.querySelector(Co) &&
                        !this._isIOS() &&
                        (this._ps = new ho(this._element.querySelector(Co), {
                            suppressScrollX: !0,
                            wheelPropagation: !1,
                        }));
                }),
                ...
                (n._setActiveLink = function () {
                    var t = this;
                    Array.from(this._element.querySelectorAll(Oo)).forEach(
                        function (e) {
                            var n;
                            "#" ===
                                (n =
                                    ...
                                    /\\?./.test(String(window.location))
                                        ...
                                        : /#./.test(String(window.location))
                                        ? String(window.location).split("#")[0]
                                        : String(window.location)).slice(-1) &&
                                (n = n.slice(0, -1));
                            var i = e.closest(Co).dataset;
                            "undefined" != typeof i.activeLinksExact &&
                                (mo.activeLinksExact = JSON.parse(
                                    i.activeLinksExact
                                )),
                                mo.activeLinksExact &&
                                    e.href === n &&
                                    (e.classList.add(_o),
                                    Array.from(t._getParents(e, ko)).forEach(
                                        function (t) {
                                            t.classList.add(yo);
                                        }
                                    )),
                ...
                (n._addEventListeners = function () {
                    ...
                    this._mobile && this._open && this._addClickOutListener(),
                        ...
                        Q.on(this._element, "classtoggle", function (e) {
                            if (
                                (e.detail.className === wo &&
                                    (t._element.classList.contains(wo)
                                        ? t.minimize()
                                        : t.reset()),
                                e.detail.className === Eo &&
                                    (t._element.classList.contains(Eo)
                                        ? t.unfoldable()
                                        : t.reset()),
                                "undefined" !=
                                    typeof Object.keys(mo.breakpoints).find(
                                        function (t) {
                                            return (
                                                mo.breakpoints[t] ===
                                                e.detail.className
                                ...
                                var n = e.detail.className,
                                    i = Object.keys(mo.breakpoints).find(
                                        function (t) {
    ...
    if (xo) {
        ...
        (xo.fn.sidebar = Ao.jQueryInterface),
            (xo.fn.sidebar.Constructor = Ao),
        ...
        Ho = (function () {
            ...
            return (
                ...
                (n._transitionComplete = function (t, e, n) {
                    ...
                    w(t),
                    t.classList.contains(Io) && t.classList.add(Po),
                    t.parentNode &&
                        t.parentNode.classList.contains("dropdown-menu")) &&
                        (t.closest(".dropdown") &&
                            st.find(".dropdown-toggle").forEach(function (t) {
    ...
    if (Wo) {
        var Yo = Wo.fn.tab;
        (Wo.fn.tab = Ho.jQueryInterface),
            (Wo.fn.tab.Constructor = Ho),
            (Wo.fn.tab.noConflict = function () {
    ...
    var Xo,
        ...
        tr = { animation: !0, autohide: !0, delay: 5e3 },
        er = (function () {
            function t(t, e) {
                (this._element = t),
                    (this._config = this._getConfig(e)),
            ...
            return (
                (n.show = function () {
                    var t = this;
                    if (
                        !Q.trigger(this._element, "show.coreui.toast")
                            .defaultPrevented
                    ) {
                        this._clearTimeout(),
                        ...
                        var e = function () {
                            t._element.classList.remove(Jo),
                                t._element.classList.add(Go),
                                Q.trigger(t._element, "shown.coreui.toast"),
                                t._config.autohide &&
                ...
                (n.hide = function () {
                    ...
                    if (
                        ...
                        !Q.trigger(this._element, "hide.coreui.toast")
                            .defaultPrevented
                    ) {
                        var e = function () {
                            t._element.classList.add($o),
                                Q.trigger(t._element, "hidden.coreui.toast");
                        };
                        if (
                ...
                (n._getConfig = function (t) {
                    return (
                        (t = o(
                            o(o({}, tr), _t.getDataAttributes(this._element)),
                            "object" == typeof t && t ? t : {}
                        )),
                        _(Fo, t, this.constructor.DefaultType),
                        t
                    );
                }),
                (n._setListeners = function () {
    ...
    if (nr) {
        var ir = nr.fn.toast;
        (nr.fn.toast = er.jQueryInterface),
            (nr.fn.toast.Constructor = er),
            (nr.fn.toast.noConflict = function () {
            ...
            (Array.from =
                ...
                function (t) {
                    ...
                    for (
                        var r,
                            s = qo(n.length),
                            a = Bo(e) ? Object(new e(s)) : new Array(s),
                            l = 0;
                        l < s;
